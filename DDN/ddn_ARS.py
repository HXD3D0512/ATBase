...
class DDN:
    ...
    def attack(self, model: nn.Module, inputs: torch.Tensor, labels: torch.Tensor, noise = None,
        ...
        for i in range(self.steps):
            ...
            is_adv = (pred_labels == labels) if targeted else (pred_labels != labels)  # 我们这里将target设为False.
            # print(is_adv)
